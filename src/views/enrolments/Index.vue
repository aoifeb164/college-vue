...
@Last modified time: 2021-03-24T15:20:03+00:00
-->
...
<div>
  ...
  <H5 class="title">Welcome to the enrolment index</H5>
</div>
  <br>
  <div class="text-center">
<!-- <b-button class="view" variant="outline-dark" @click="getenrolments()">View enrolments</b-button> -->
<b-button class="view" variant="outline"><router-link :to="{ name: 'enrolments_create'}">Create enrolment</router-link></b-button>
...
<div class="container">
  <b-table striped hover :items="enrolments" :fields="fields" >
    ...
    <template #cell(actions)="data">
      <router-link :to="{ name: 'enrolments_edit', params: { id: data.item.id }}"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-pencil-square editButton" viewBox="0 0 16 16">
