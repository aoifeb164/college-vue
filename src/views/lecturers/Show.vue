...
@Last modified time: 2021-04-20T17:23:14+01:00
-->
...
<div class="container">
  <b-card class="shadow p-3 mb-5 bg-white rounded show-card">
    <b-row>
      ...
      <b-col>
        ...
        <br>
        <h5>Email: </h5> {{ lecturer.email }}
        <br>
        <h5>Phone: </h5> {{ lecturer.phone }}
      </b-col>
    </b-row>
  </b-card>
  ...
  <b-pagination v-model="currentPage" pills color="black" :total-rows="rows" :per-page="perPage" aria-controls="my-table" align="center"></b-pagination>
</div>
</template>
